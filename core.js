...
export const STRINGS = {
  tr: {
    ...
    maxDrawdownAll: 'En derin düşüş',
    dailyTitle: 'Gün gün getiri',
    dailyCount: '{n} işlem günü · {from} tarihinden beri',
    dailyMore: '{n} gün daha göster',
    date: 'Tarih',
    maxDrawdownHint: 'Son bir yıl içindeki en derin tepe-dip kaybı.',
    maxDrawdownAllHint:
      'Elimizdeki tüm geçmiş boyunca en derin tepe-dip kaybı. Yanındaki bir ' +
      'yıllık rakam kötü bir yılın nasıl göründüğünü, bu ise en kötüsünün ne ' +
      'yaptığını söyler.',
    ...
    tabRisk: 'Risk',
    tabHoldings: 'Portföy',
    tabsLabel: 'Fon sayfası bölümleri',
    portfolio: 'Portföy dağılımı',
    mixRing: 'Varlık dağılımı',
  ...
  en: {
    ...
    maxDrawdownAll: 'Deepest fall',
    dailyTitle: 'Day by day',
    dailyCount: '{n} trading days · since {from}',
    dailyMore: 'Show {n} more days',
    date: 'Date',
    maxDrawdownHint: 'The deepest peak-to-trough loss within the last year.',
    maxDrawdownAllHint:
      'The deepest peak-to-trough loss across all the history we hold. The ' +
      'one-year figure beside it says what a bad year looked like; this says ' +
      'what the worst of them did.',
