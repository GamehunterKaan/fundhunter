...
export const STRINGS = {
  tr: {
    ...
    posCost: 'Maliyet',
    posCostHint: 'Toplam ödediğiniz tutar. Boş bırakırsanız aldığınız günün fiyatı kullanılır.',
    posCostNow: 'Bugünkü fiyattan hesapla',
    posDateHint: 'Aldığınız gün. Seçtiğinizde maliyet o günün fiyatından hesaplanır.',
  ...
  en: {
    ...
    posCost: 'Cost',
    posCostHint: 'What you paid in total. Left empty, the price on the day you bought it is used.',
    posCostNow: 'Cost it at today’s price',
    posDateHint: 'The day you bought it. Picking one costs the position at that day’s price.',
    posPrice: 'Price now',
    posValue: 'Value',
